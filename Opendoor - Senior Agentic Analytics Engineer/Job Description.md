...
**Compensation:** Base $186,000–$256,000 annually, plus RSUs and bonuses. Unlimited PTO, medical/dental/vision, life insurance, 401(k).
**Source:** Pasted by user on 2026-06-06
...
The base pay range for this position based on level is $186,000–$256,000 annually, plus RSUs and bonuses. Pay within this range varies by work location and may also depend on your qualifications, job-related knowledge, skills, and experience. Comprehensive benefits including unlimited PTO, medical/dental/vision insurance, life insurance, and 401(k) to eligible employees.

## Notes for Kanu

- **Strongest archetype match in the pipeline so far.** This role is almost a literal description of your Walmart work: moving analytics from static reporting to AI-augmented/agentic, NL-to-SQL interfaces, semantic layers, agents that surface insights proactively. The NL-to-SQL Copilot, KPI monitor, and analytics agent stories map 1:1.
- **"Senior+" / IC role, no people management implied** — comp band ($186K–$256K base + RSUs + bonus) is well above your other active roles; this is a level-flexible senior IC posting.
- **Location is not stated in the JD** — only "varies by work location." Confirm remote vs. onsite/hybrid + city at the first recruiter touchpoint before investing in tailoring.
- **They explicitly use Claude** ("Implement end-to-end solutions using Claude, custom agents") — your Wibey/Claude Code daily-driver experience is a direct, ownable hook.
- **Domain bonus:** real estate / fintech / marketplace — you don't have this, but it's a bonus, not a gate.
- **"Decisions influenced, not dashboards built"** is the explicit success metric — tailor your impact bullets to decisions/actions driven, not deliverables produced.
