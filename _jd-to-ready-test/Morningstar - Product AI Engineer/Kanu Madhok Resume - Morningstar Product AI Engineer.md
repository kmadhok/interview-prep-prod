...
_Text source for the .docx / .pdf. Tailored for Morningstar — Product AI Engineer (REQ-055251), a Forward-Deployed AI Engineer / rapid-prototyping role. In the formatted version, city · date sit right-aligned to the page edge._
...
- Rapidly prototyped and live-deployed a text-to-SQL copilot (Streamlit + Gemini 2.5 + LangChain-orchestrated RAG over historical queries, BigQuery execution, auto-visualization): live demo — https://sql-rag-frontend-simple-481433773942.us-central1.run.app/

---

## SKILLS

AI dev tools: Claude Code, Cursor — agentic coding workflows, rapid prototyping with limited infrastructure
