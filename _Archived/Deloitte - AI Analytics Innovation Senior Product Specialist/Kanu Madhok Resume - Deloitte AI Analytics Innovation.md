...
- Built a headless KPI monitor on a 6-hour cron that detects threshold breaches, runs root-cause analysis, and posts Slack alerts; state persists to BigQuery. Designed a v2 architecture as a 3-tier event-driven platform self-configuring via a BigQuery event registry. New event types ship without code deploys.
