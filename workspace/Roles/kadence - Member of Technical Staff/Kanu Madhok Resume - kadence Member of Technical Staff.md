...
_End-to-end AI engineer who ships production agentic systems — LLMs, retrieval, tool orchestration, and evaluation — that deliver actionable insight, not just chat, with measurable business impact._
