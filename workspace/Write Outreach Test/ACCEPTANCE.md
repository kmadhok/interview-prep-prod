...
- [ ] **R1.** The model committed a diff to `~/.claude/skills/write-outreach/SKILL.md` and/or `Outreach Templates.md`. An empty skill diff with non-trivial email changes = **disqualified run**.
