...
You are improving the `write-outreach` skill at `~/.claude/skills/write-outreach/SKILL.md`,
...
gold-standard email in `Write Outreach Test/fixtures/gold-email.md`. You are judged on the
...
1. **Read** `fixtures/gold-email.md`, `Outreach Templates.md` (§1), the current
   `write-outreach/SKILL.md`, `Resume Achievements Master.md`, and `Demo Portfolio.md`.
...
4. **Write outputs** to `Write Outreach Test/runs/<your-model-name>/<role-slug>.md`. Each file:
