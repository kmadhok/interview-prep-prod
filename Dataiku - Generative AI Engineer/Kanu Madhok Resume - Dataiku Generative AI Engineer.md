...
> **NOTE:** JD body is empty in this folder (LinkedIn paste pending). This resume is built from the role title alone (Generative AI Engineer at a platform vendor). Re-tailor after pasting the full JD.
